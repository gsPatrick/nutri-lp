            ...
            <div className={styles.layout}>
                ...
                >
                    ...
                    <div className={styles.header}>
                        <p className={styles.subtitle}>Checkout de Luxo</p>
                    ...
                    <div className={styles.orderSummary}>
                        ...
                        <div className={styles.orderItem}>
                            <span>{productConfig.productName} (Turma 3)</span>
                ...
                {/* Benefits Sidebar */}
                <motion.div
                    className={styles.benefitsSidebar}
                ...
                >
                    <div className={styles.benefitsContent}>
                        ...
                        <div className={styles.summaryNote}>
                            <p>Sua jornada de 15 dias começa no dia <strong>13/04</strong>. Estamos prontas para te receber!</p>
                        </div>
                    </div>
                </motion.div>
            </div>
